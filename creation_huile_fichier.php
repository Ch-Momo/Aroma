...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/creation_huile_fichier.css" title="style" />
		<noscript>
	...
	<body class="homepage">
		...
		<!-- Le contenu -->
			<div id="main" class="wrapper style1">	
				...
				<h2 id="titre"> <img  id="huile" src="images/huile3.png" width="100" length="100"/> <span id="titre">Création de plusieurs huiles essentielles : </p></h2><br/>
  				<?php
  				...
  				<form enctype="multipart/form-data" action="" method="post">
  						<p>Sélectionnez les fichiers sous format "zip". Cliquez <a href="creation_huile_fichier_infos.php">ici</a> pour plus d'informations.</p>
