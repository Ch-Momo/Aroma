...
<head>
  <meta charset="utf-8">
  <title>Modification d'un traitement</title>
...
<p><label> Lien image : </label> <input type="text" name="image" id="image" value="<?php echo $image;?>"/></p>
</br>
<p><label> Lien vidéo : </label> <input type="text" name="video" id="video" value="<?php echo $video;?>"/></p>
</br>
...
<?php 
	...
	if(traitementExiste($bd, $_POST['nom']))
		...
		$idtraitement = recupererIdtraitement($bd, $_POST['nom']);
         ...
         miseAjourTraitement($bd, $_POST['nom'], $_POST['description'], $_POST['modalite'], $_POST['image'], $_POST['video'], $_GET['id-traitement']);
