...
if(isset($_POST['conf']))
{
if(trim($_POST['nom'])=='' or trim($_POST['pathologie'])=='' or trim($_POST['description'])=='' or trim($_POST['modalite'])==''){
...
?>
<?php
$lien='Ajouter une brève description';
?>
...
<input list="pathologie" name="pathologie" required />
...
<p><label> Description du traitement : *</label></br><textarea name="description" cols="50" rows="7"><?php echo $lien; ?></textarea></p>
