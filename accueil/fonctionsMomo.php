...
function listboxConstituants($bd,$numero){
	...
	*/
	try{
		...
		echo'</datalist>';
		echo ' à  <input type="text" name="pourcentage'.$numero.'" id="pourcentage'.$numero.'"/ class="constituants_pourcentages">%';
...
function listboxProprietesEtNotations($bd,$numero){
	try{
		...
		*/
		...
		$req2->execute();
		echo '<input name="notation'.$numero.'" list="choixNotation" type="text" size ="1" autocomplete="off" placeholder="Sélectionnez la notation correspendante..." id="notation'.$numero.'" class="proprietes_notations"/>
...
function formulaire_creation_huile($bd){
	...
	echo '<p> Proprietes/Notations : <span id="err_proprietes_notations" class="vide">Champs invalides</span> </p>';
	for($i=1;$i<6;$i++){
		listboxProprietesEtNotations($bd,$i);
		echo'<br/>';
	}
	echo '<p> Conseils : <span id="err_conseils" class="vide">Champs invalides</span> </p> <textarea cols="60" rows="5" name="conseils" placeholder="Donnez quelques conseils sur l\'huile..." id="form_conseils"></textarea>
			<p> Indications : <span id="err_indications" class="vide">Champs invalides</span></p> <textarea cols="60" rows="5" name="indications" placeholder="Donnez quelques indications sur l\'huile..." id="form_indications"></textarea>
			<p> Mode(s) d\'emploi : </p> ';
	...
	echo '<p> Message enérgétique : <span id="err_message" class="vide">Champs invalides</span> </p> <textarea cols="60" rows="5" name="message_energetique" placeholder="Saisissez un message enérgétique..." id="form_message"></textarea>
			<p> Sélectionnez une image :<br/> <br/><input type="file" name="image"/>  </p> 
...
function formulaire_creation_huile_prerempli($bd,$tab){
	...
	echo '<p> Conseils : <span id="err_conseils" class="vide">Champs invalides</span> </p> <textarea cols="60" rows="5" name="conseils" placeholder="Donnez quelques conseils sur l\'huile..." id="form_conseils" >'.$tab['conseils'].'</textarea>
			<p> Indications : <span id="err_indications" class="vide">Champs invalides</span></p> <textarea cols="60" rows="5" name="indications" placeholder="Donnez quelques indications sur l\'huile..." id="form_indications">'.$tab['indications'].'</textarea>
			<p> Mode(s) d\'emploi : </p> ';
	listboxModeEmploi($bd);
